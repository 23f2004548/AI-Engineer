...
paper_input = st.selectbox('Select Research Paper Name',["Attention Is All You Need","BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding", "GPT-3: Language Models are Few-Shot Learners","Diffusion Models Beat GANs on Image Synthesis","AlphaFold: Using AI for scientific discovery"])

style_input =st.selectbox('Select Eplanation Style',["Beginner-Friendly","Technical","Code-Oriented","Mathematical","Visual Explanation","Analogy-Based","Historical Context","Future Implications"])
